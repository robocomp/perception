...
void __writeMotorGoalVelocityList(::IceInternal::BasicStream*, const ::RoboCompJointMotor::MotorGoalVelocity*, const ::RoboCompJointMotor::MotorGoalVelocity*);
void __readMotorGoalVelocityList(::IceInternal::BasicStream*, MotorGoalVelocityList&);
...
private:
    ...
    void stopAllMotors(const ::Ice::Context*);
...
public:
    ...
    void stopMotor(const ::std::string& motor, const ::Ice::Context& __ctx)
    {
        stopMotor(motor, &__ctx);
    }
    
private:

    void stopMotor(const ::std::string&, const ::Ice::Context*);
    
public:

    void releaseBrakeAllMotors()
    {
        releaseBrakeAllMotors(0);
    }
    void releaseBrakeAllMotors(const ::Ice::Context& __ctx)
    {
        releaseBrakeAllMotors(&__ctx);
    }
    
private:

    void releaseBrakeAllMotors(const ::Ice::Context*);
    
public:

    void releaseBrakeMotor(const ::std::string& motor)
    {
        releaseBrakeMotor(motor, 0);
    }
    void releaseBrakeMotor(const ::std::string& motor, const ::Ice::Context& __ctx)
    {
        releaseBrakeMotor(motor, &__ctx);
    }
    
private:

    void releaseBrakeMotor(const ::std::string&, const ::Ice::Context*);
    
public:

    void enableBrakeAllMotors()
    {
        enableBrakeAllMotors(0);
    }
    void enableBrakeAllMotors(const ::Ice::Context& __ctx)
    {
        enableBrakeAllMotors(&__ctx);
    }
    
private:

    void enableBrakeAllMotors(const ::Ice::Context*);
    
public:

    void enableBrakeMotor(const ::std::string& motor)
    {
        enableBrakeMotor(motor, 0);
    }
    void enableBrakeMotor(const ::std::string& motor, const ::Ice::Context& __ctx)
    {
        enableBrakeMotor(motor, &__ctx);
    }
    
private:

    void enableBrakeMotor(const ::std::string&, const ::Ice::Context*);
...
public:
    ...
    virtual void setZeroPos(const ::std::string&, const ::Ice::Context*) = 0;

    virtual void setSyncPosition(const ::RoboCompJointMotor::MotorGoalPositionList&, const ::Ice::Context*) = 0;

    virtual void setSyncVelocity(const ::RoboCompJointMotor::MotorGoalVelocityList&, const ::Ice::Context*) = 0;

    virtual void setSyncZeroPos(const ::Ice::Context*) = 0;
    ...
    virtual void stopMotor(const ::std::string&, const ::Ice::Context*) = 0;

    virtual void releaseBrakeAllMotors(const ::Ice::Context*) = 0;

    virtual void releaseBrakeMotor(const ::std::string&, const ::Ice::Context*) = 0;

    virtual void enableBrakeAllMotors(const ::Ice::Context*) = 0;

    virtual void enableBrakeMotor(const ::std::string&, const ::Ice::Context*) = 0;
};
...
public:
    ...
    virtual void setZeroPos(const ::std::string&, const ::Ice::Context*);

    virtual void setSyncPosition(const ::RoboCompJointMotor::MotorGoalPositionList&, const ::Ice::Context*);

    virtual void setSyncVelocity(const ::RoboCompJointMotor::MotorGoalVelocityList&, const ::Ice::Context*);

    virtual void setSyncZeroPos(const ::Ice::Context*);
    ...
    virtual void stopAllMotors(const ::Ice::Context*);

    virtual void stopMotor(const ::std::string&, const ::Ice::Context*);

    virtual void releaseBrakeAllMotors(const ::Ice::Context*);

    virtual void releaseBrakeMotor(const ::std::string&, const ::Ice::Context*);

    virtual void enableBrakeAllMotors(const ::Ice::Context*);

    virtual void enableBrakeMotor(const ::std::string&, const ::Ice::Context*);
};
...
public:
    ...
    virtual void stopMotor(const ::std::string&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___stopMotor(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual void releaseBrakeAllMotors(const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___releaseBrakeAllMotors(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual void releaseBrakeMotor(const ::std::string&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___releaseBrakeMotor(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual void enableBrakeAllMotors(const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___enableBrakeAllMotors(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual void enableBrakeMotor(const ::std::string&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___enableBrakeMotor(::IceInternal::Incoming&, const ::Ice::Current&);
