...
void SpecificMonitor::readConfig(RoboCompCommonBehavior::ParameterList &params )
{
	...
	aux.editable = true;
	configGetString( "artComp.markerPath",aux.value,"");
	params["markerPath"] = aux;
	configGetString( "artComp.markerSize",aux.value,"");
	params["markerSize"] = aux;
	configGetString( "artComp.isSingleMarker",aux.value,"");
	params["isSingleMarker"] = aux;
	configGetString( "artComp.cameraData",aux.value,"");
	params["cameraData"] = aux;
	configGetString( "artComp.probability",aux.value,"");
	params["probability"] = aux;
