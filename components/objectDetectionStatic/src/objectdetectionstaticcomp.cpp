...
class objectDetectionStaticComp : public RoboComp::Application
{
private:
...
void objectDetectionStaticComp::initialize()
{
...
int objectDetectionStaticComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
