...
/** \mainpage RoboComp::testOracle
 *
 * \section intro_sec Introduction
 *
 * The testOracle component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/testOracle --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class testOracle : public RoboComp::Application
{
public:
	testOracle (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::testOracle::run(int argc, char* argv[])
{
